...
iframe.onload = () => {
      // إخفاء جميع العناصر الأخرى في الصفحة
      document.body.innerHTML = '';

      // إضافة iframe إلى body مباشرةً
      document.body.appendChild(iframe);

      // ضبط styles لـ iframe ليأخذ كامل مساحة الصفحة
      iframe.style.width = '100%';
      iframe.style.height = '100%';
      iframe.style.border = 'none'; // لإزالة أي حدود افتراضية
    };
  }
}

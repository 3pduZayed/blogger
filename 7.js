...
// دالة لإخفاء العناصر غير المرغوب فيها
function hideAdsAndMessages() {
...
function updateIframeSource(pageUrl) {
    ...
    if (isBlocked) {
        ...
        // الموقع ليس محظورًا، حاول تحميله وإخفاء العناصر
        console.log('Attempting to load site:', pageUrl);
        iframe.classList.remove('hidden-iframe'); // إظهار الـ iframe
        hideAdsAndMessages(); // إخفاء الإعلانات والرسائل
